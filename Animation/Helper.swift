...
open class Canvas : CustomPlaygroundQuickLookable {
    ...
    open func drawLine(fromX: Int, fromY: Int, toX: Int, toY: Int, lineWidth: Int = 0, capStyle : NSLineCapStyle = NSLineCapStyle.squareLineCapStyle) {
        ...
        drawLine(fromX: Float(fromX), fromY: Float(fromY), toX: Float(toX), toY: Float(toY), lineWidth: lineWidth, capStyle: capStyle)
    ...
    open func translate(byX: Int, byY: Int) {
        ...
        translate(byX: Float(byX), byY: Float(byY))
        
    }
    
    open func translate(byX: Float, byY: Float) {
